  ...
  const calculation = useMemo(() => {
    ...
    const opHours = {
      ...
      extras: config.extras.reduce(
        (acc, extra) =>
          acc + WORK_TIMES.EXTRAS[extra.service] * extra.dimension,
        0,
      ),
    };
    ...
    const vehicleCosts = config.vehicles.reduce((acc, segment) => {
      return (
        acc + months * washesPerCarPerMonth * UNIT_PRICES.CAR_WASH[segment]
      );
    }, 0);
    ...
    const totalPlan =
      totalIndividual * (1 - planDiscount) * (1 - periodDiscount);
    ...
    const housesStandard =
      (simConfig.totalHouses * simConfig.standardPct) / 100;
    ...
    const totalSalaries =
      teamsNeeded * 2 * simConfig.salaryBase +
      teamsNeeded * simConfig.salaryLead;
    ...
    const projection = Array.from({ length: 12 }, (_, i) => {
      ...
      const monthSalaries =
        monthTeams * 2 * simConfig.salaryBase +
        monthTeams * simConfig.salaryLead;
      const monthSupplies =
        monthHouses * simConfig.suppliesPerHouse +
        simConfig.brokerPacksPerMonth * 40000; // Extra supplies for broker packs
      ...
      <main className="max-w-6xl mx-auto px-6 -mt-10">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-stone-600 leading-relaxed">
                En <strong>TU MAYORDOMO</strong>, redefinimos el mantenimiento
                del hogar en Colina. Nacimos de la necesidad de ofrecer un
                servicio de excelencia, coordinado y profesional para las
                residencias más exigentes de la zona.
              </p>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="p-6 bg-white rounded-2xl border border-stone-100 shadow-sm">
                  ...
                  <p className="text-xs text-stone-500">
                    Ser el referente de mayordomía de hogares en Chile,
                    destacando por innovación y calidad.
                  </p>
                </div>
              </div>
              ...
              <div className="p-6 bg-emerald-50 rounded-2xl border border-emerald-100">
                ...
                <p className="text-sm text-emerald-800 leading-relaxed">
                  ...
                  mantenimiento técnico de piscinas y detailing automotriz.
                  Nuestra estrategia se basa en la{" "}
                  <strong>integración vertical</strong>: un solo equipo
                  altamente capacitado que conoce cada rincón de tu hogar.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-2xl shadow-xl border border-stone-100 max-w-[240px]">
                ...
                <p className="text-[10px] text-stone-500">
                  Si un servicio no cumple tu expectativa, lo repetimos sin
                  costo adicional.
                </p>
              </div>
            </motion.div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white border border-stone-100 rounded-3xl p-6 shadow-sm hover:shadow-md transition-shadow">
                      ...
                      <div className="pt-4 border-t border-stone-50 space-y-4">
                        ...
                        <div className="space-y-1 max-h-[240px] overflow-y-auto pr-2 custom-scrollbar">
                          {calculation.serviceBreakdown.garden.map(
                            (item, idx) => (
                              <div
                                key={idx}
                    ...
                    <div className="bg-white border border-stone-100 rounded-3xl p-6 shadow-sm hover:shadow-md transition-shadow">
                      ...
                      <div className="pt-4 border-t border-stone-50 space-y-4">
                        ...
                        <div className="space-y-1 max-h-[240px] overflow-y-auto pr-2 custom-scrollbar">
                          {calculation.serviceBreakdown.pool.map(
                            (item, idx) => (
                              <div
                                key={idx}
                                className="flex items-center justify-between bg-stone-50 rounded-xl px-4 py-2 border border-stone-100"
                    ...
                    <div className="bg-white border border-stone-100 rounded-3xl p-6 shadow-sm hover:shadow-md transition-shadow">
                      ...
                      <div className="pt-4 border-t border-stone-50 space-y-4">
                        <div className="flex justify-between text-[11px] text-stone-400 uppercase tracking-wider">
                          <span>Desglose Mensual ({config.period})</span>
                          <span className="font-bold text-stone-600">
                            {calculation.visits.windowCleanings} limpiezas
                            totales
                          </span>
                        </div>

                        <div className="space-y-1 max-h-[240px] overflow-y-auto pr-2 custom-scrollbar">
                          {calculation.serviceBreakdown.windows.map(
                            (item, idx) => (
                              <div
                                key={idx}
                                className="flex items-center justify-between bg-stone-50 rounded-xl px-4 py-2 border border-stone-100"
                    ...
                    <div className="bg-white border border-stone-100 rounded-3xl p-6 shadow-sm hover:shadow-md transition-shadow md:col-span-2">
                      ...
                      <div className="pt-4 border-t border-stone-50 space-y-4">
                        <div className="flex justify-between text-[11px] text-stone-400 uppercase tracking-wider">
                          <span>Desglose Mensual ({config.period})</span>
                          <span className="font-bold text-stone-600">
                            {calculation.visits.pavementCleanings} servicios
                            totales
                          </span>
                        </div>

                        <div className="space-y-1 max-h-[240px] overflow-y-auto pr-2 custom-scrollbar">
                          {calculation.serviceBreakdown.pavement.map(
                            (item, idx) => (
                              <div
                                key={idx}
                                className="flex items-center justify-between bg-stone-50 rounded-xl px-4 py-2 border border-stone-100"
                              ...
                              {isSelected && (
                                <div className="flex items-center justify-between bg-white p-3 rounded-xl border border-emerald-100 shadow-sm">
                                  <div className="flex items-center gap-4">
                                    <button
                                      onClick={() => {
                                        const newExtras = config.extras.map(
                                          (e) =>
                ...
                <section className="bg-stone-900 text-white rounded-3xl p-8 shadow-2xl overflow-hidden relative">
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="space-y-2 border-y border-white/10 py-4 my-4">
                      ...
                      <div className="flex justify-between items-center text-stone-400 text-xs">
                        <span>
                          ...
                          {formatCLP(UNIT_PRICES.GARDEN[config.gardenSize])}/v)
                        </span>
                        <span>{formatCLP(calculation.costs.garden)}</span>
                      </div>
                      <div className="flex justify-between items-center text-stone-400 text-xs">
                        <span>
                          Mantenimiento Piscina ({formatCLP(UNIT_PRICES.POOL)}
                          /v)
                        </span>
                        <span>{formatCLP(calculation.costs.pool)}</span>
                      </div>
                      <div className="flex justify-between items-center text-stone-400 text-xs">
                        <span>
                          Lavado Automotriz (
                          {formatCLP(
                            calculation.costs.car /
                              calculation.visits.carWashes,
                          )}
                          /v)
                        </span>
                        <span>{formatCLP(calculation.costs.car)}</span>
                      ...
                      <div className="flex justify-between items-center text-stone-400 text-xs">
                        <span>
                          Limpieza de Vidrios (
                          {formatCLP(UNIT_PRICES.WINDOWS[config.windowPanes])}
                          /v)
                        </span>
                        <span>{formatCLP(calculation.costs.windows)}</span>
                      </div>
                    ...
                    <div className="space-y-2 border-t border-white/10 pt-4">
                      <div className="flex justify-between items-center">
                        <span className="text-emerald-400 text-sm">
                          Descuento Pack {config.plan} (
                          {calculation.discounts.plan * 100}%)
                        </span>
                        <span className="text-emerald-400 text-sm">
                          -
                          {formatCLP(
                            calculation.totalIndividual *
                              calculation.discounts.plan,
                          )}
                        </span>
                      </div>
                      ...
                      {calculation.discounts.period > 0 && (
                        <div className="flex justify-between items-center">
                          <span className="text-emerald-400 text-sm">
                            Descuento Permanencia {config.period} (
                            {calculation.discounts.period * 100}%)
                          </span>
                          <span className="text-emerald-400 text-sm">
                            -
                            {formatCLP(
                              calculation.totalIndividual *
                                (1 - calculation.discounts.plan) *
                                calculation.discounts.period,
                            )}
                          </span>
                        </div>
                      )}
                          ...
                          {config.extras.map((extra, idx) => (
                            ...
                            >
                              ...
                              <span className="text-stone-300">
                                {formatCLP(
                                  UNIT_PRICES.EXTRAS[extra.service] *
                                    extra.dimension,
                                )}
                              </span>
                            </div>
                    ...
                    <p className="text-[10px] text-emerald-500/60 text-center mt-2 font-medium">
                      ¡Ahorras{" "}
                      {formatCLP(
                        calculation.individualMonthlyAverage -
                          calculation.monthlyEquivalent,
                      )}{" "}
                      cada mes comparado con el precio individual!
                    </p>
                  ...
                  <div className="space-y-3 mb-8">
                    ...
                    {calculation.visits.windowCleanings > 0 && (
                      <div className="flex items-center gap-2 text-sm text-stone-300">
                        <CheckCircle2 size={16} className="text-emerald-500" />
                        <span>
                          {calculation.visits.windowCleanings} Limpiezas de
                          Vidrios
                        </span>
                      </div>
                    )}
        ...
        <section id="beneficios" className="pt-24 mb-24">
          <div className="text-center mb-16">
            ...
            <p className="text-stone-500 max-w-2xl mx-auto">
              En Tu Mayordomo premiamos tu confianza. Refiere a tus vecinos y
              amigos para obtener beneficios exclusivos en tu plan mensual.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-stone-900 p-8 rounded-[2.5rem] text-white shadow-2xl relative overflow-hidden group">
              ...
              <p className="text-stone-300 text-sm leading-relaxed mb-6">
                ...
                <span className="text-emerald-400 font-bold">Mes Gratis</span>{" "}
                de mantenimiento de piscina o Car Detailing Full para un
                vehículo.
              </p>
            ...
            <div className="max-w-4xl mx-auto relative z-10">
              <div className="text-center mb-12">
                ...
                <p className="text-emerald-100/70 max-w-xl mx-auto">
                  Ayúdanos a mantener la excelencia. Tu feedback es fundamental
                  para seguir mejorando nuestro servicio premium.
                </p>
              </div>
                ...
                >
                  ...
                  <div className="space-y-6 pt-6 border-t border-stone-100">
                    <label className="block text-center text-sm font-black uppercase tracking-widest text-stone-500">
                      ¿Qué tan probable es que nos recomiendes a un amigo o
                      vecino?
                    </label>
                  ...
                  <div className="flex flex-col md:flex-row gap-6 items-center justify-between pt-6 border-t border-stone-100">
                    <p className="text-[10px] text-stone-400 max-w-xs leading-relaxed">
                      Al enviar esta encuesta, nos autorizas a procesar tus
                      datos para mejorar nuestro servicio. Tu privacidad es
                      nuestra prioridad.
                    </p>
                    <button
                      type="submit"
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-12">
                <div className="bg-white/5 p-6 rounded-2xl border border-white/10">
                  ...
                  <p className="text-xs text-stone-500 mt-4 leading-relaxed">
                    Basado en 40h semanales de servicio efectivo (trabajo en
                    bloque).
                  </p>
                </div>
                      ...
                      <div className="space-y-3">
                        {items.map((item) => (
                          <button
                            key={item.id}
                            onClick={() =>
                              toggleChecklistItem(category, item.id)
                            }
                ...
                <div className="grid lg:grid-cols-12 gap-12">
                    ...
                    <div className="pt-8 border-t border-white/5 space-y-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-[9px] text-stone-500 italic">
                          Porcentaje de clientes que contratan servicios extra
                          al mes.
                        </p>
                      </div>
                      ...
                      <div className="space-y-4">
                        <div className="flex justify-between text-xs font-bold">
                          ...
                          <span className="text-white">
                            {simConfig.marketplaceCommissionPct}%
                          </span>
                        </div>
                        <input
                          type="range"
                          min="5"
                          max="25"
                          value={simConfig.marketplaceCommissionPct}
                          onChange={(e) =>
                            setSimConfig({
                              ...simConfig,
                              marketplaceCommissionPct: parseInt(
                                e.target.value,
                              ),
                            })
                          }
                    ...
                    <div className="pt-8 border-t border-white/5 space-y-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <input
                          ...
                          min="0"
                          max="20"
                          value={simConfig.brokerPacksPerMonth}
                          onChange={(e) =>
                            setSimConfig({
                              ...simConfig,
                              brokerPacksPerMonth: parseInt(e.target.value),
                            })
                          }
                          className="w-full accent-blue-500"
                        />
                        <p className="text-[9px] text-stone-500 italic">
                          Número de servicios "Pack Entrega Propiedad" vendidos
                          a corredoras.
                        </p>
                      </div>
                      ...
                      <div className="space-y-4">
                        <div className="flex justify-between text-xs font-bold">
                          ...
                          <span className="text-white">
                            {formatCLP(simConfig.brokerPackPrice)}
                          </span>
                        </div>
                    ...
                    <div className="pt-8 border-t border-white/5 space-y-6">
                            ...
                            const ratio =
                              simConfig.standardPct + simConfig.premiumPct === 0
                                ...
                                : simConfig.standardPct /
                                  (simConfig.standardPct +
                                    simConfig.premiumPct);
                            setSimConfig({
                              ...simConfig,
                              basicPct: val,
                              standardPct: Math.round(remaining * ratio),
                              premiumPct:
                                100 - val - Math.round(remaining * ratio),
                            });
                          }}
                          className="w-full accent-emerald-500"
                        />
                      ...
                      <div className="space-y-4">
                        ...
                        <input
                          ...
                          min="0"
                          max="100"
                          value={simConfig.standardPct}
                          onChange={(e) => {
                            const val = parseInt(e.target.value);
                            const remaining = 100 - val;
                            const ratio =
                              simConfig.basicPct + simConfig.premiumPct === 0
                                ? 0.5
                                : simConfig.basicPct /
                                  (simConfig.basicPct + simConfig.premiumPct);
                            setSimConfig({
                              ...simConfig,
                              standardPct: val,
                      ...
                      <div className="space-y-4">
                        ...
                        <input
                          ...
                          min="0"
                          max="100"
                          value={simConfig.premiumPct}
                          onChange={(e) => {
                            const val = parseInt(e.target.value);
                            const remaining = 100 - val;
                            const ratio =
                              simConfig.basicPct + simConfig.standardPct === 0
                                ? 0.5
                                : simConfig.basicPct /
                                  (simConfig.basicPct + simConfig.standardPct);
                            setSimConfig({
                              ...simConfig,
                              premiumPct: val,
                              basicPct: Math.round(remaining * ratio),
                  ...
                  <div className="lg:col-span-7 grid grid-cols-2 gap-4">
                    <div className="bg-white/5 p-8 rounded-3xl border border-white/10 flex flex-col justify-center">
                      ...
                      <div className="flex items-end gap-2">
                        <span className="text-6xl font-black text-emerald-400">
                          {calculation.simResults.peopleNeeded}
                        </span>
                        <span className="text-stone-400 text-sm mb-2">
                          Personas
                        </span>
                      </div>
                      <p className="text-xs text-stone-500 mt-4">
                        Organizadas en{" "}
                        {Math.ceil(calculation.simResults.teamsNeeded)} equipos
                        de 3.
                      </p>
                    </div>
                    ...
                    <div className="bg-white/5 p-8 rounded-3xl border border-white/10 flex flex-col justify-center">
                      ...
                      <div className="flex items-end gap-2">
                        <span className="text-6xl font-black text-emerald-400">
                          {Math.round(calculation.simResults.totalMonthlyHours)}
                        </span>
                        <span className="text-stone-400 text-sm mb-2">
                          Horas/Mes
                        </span>
                      ...
                      <p className="text-xs text-stone-500 mt-4">
                        ...
                        {calculation.simResults.utilization.toFixed(1)}%
                      </p>
                    </div>
                    ...
                    <div className="col-span-2 bg-stone-800 p-8 rounded-3xl border border-white/10 flex items-center justify-between">
                      <div>
                        <p className="text-[10px] font-black uppercase tracking-widest text-stone-500 mb-4">
                          Venta Mensual Estimada (Mix)
                        </p>
                        <div className="flex items-end gap-2">
                          <span className="text-5xl font-black text-emerald-400">
                            {formatCLP(
                              calculation.simResults.totalMonthlySales,
                            )}
                          </span>
                          <span className="text-stone-400 text-sm mb-2">
                            / Mes
                    ...
                    <div className="col-span-2 bg-emerald-500/10 p-8 rounded-3xl border border-emerald-500/20">
                      <h4 className="text-sm font-black uppercase tracking-widest text-emerald-400 mb-6">
                        Desglose de Cartera y Ecosistema
                      </h4>
                      <div className="grid grid-cols-4 gap-8">
                        <div>
                          <p className="text-3xl font-black">
                            {Math.round(calculation.simResults.houses.basic)}
                          </p>
                        ...
                        <div>
                          <p className="text-3xl font-black">
                            {Math.round(calculation.simResults.houses.standard)}
                          </p>
                          <p className="text-[10px] font-bold text-stone-500 uppercase">
                            Casas Estándar
                          </p>
                        ...
                        <div>
                          <p className="text-3xl font-black">
                            {Math.round(calculation.simResults.houses.premium)}
                          </p>
                          <p className="text-[10px] font-bold text-stone-500 uppercase">
                            Casas Premium
                          </p>
                      ...
                      <div className="space-y-6">
                        <div className="space-y-3 border-b border-white/5 pb-4">
                          <div className="flex justify-between items-center">
                            <span className="text-stone-500 text-xs font-bold uppercase">
                              Ingresos Core (Planes)
                            </span>
                            <span className="text-lg font-bold text-white">
                              {formatCLP(
                                calculation.simResults.financials
                                  .coreMonthlySales,
                              )}
                            </span>
                          </div>
                          ...
                          <div className="flex justify-between items-center">
                            <span className="text-blue-400 text-xs font-bold uppercase">
                              Ventas Corredoras (Packs)
                            </span>
                            <span className="text-lg font-bold text-blue-400">
                              +
                              {formatCLP(
                                calculation.simResults.financials.brokerRevenue,
                              )}
                            </span>
                          </div>
                          <div className="flex justify-between items-center pt-2 border-t border-white/5">
                            <span className="text-stone-300 text-xs font-black uppercase">
                              Ingresos Totales
                            </span>
                        ...
                        <div className="space-y-3">
                          <div className="flex justify-between text-xs">
                            <span className="text-stone-500">
                              Sueldos (2x650k + 1x850k)
                            </span>
                            <span className="text-red-400 font-bold">
                              -
                              {formatCLP(
                                calculation.simResults.financials.totalSalaries,
                              )}
                            </span>
                          </div>
                          <div className="flex justify-between text-xs">
                            <span className="text-stone-500">
                              Insumos y Químicos (Est.)
                            </span>
                            <span className="text-red-400 font-bold">
                              -
                              {formatCLP(
                                calculation.simResults.financials.totalSupplies,
                              )}
                            </span>
                          </div>
                          <div className="flex justify-between text-xs">
                            <span className="text-stone-500">
                              Gastos Operativos (Combustible/Herramientas)
                            </span>
                            <span className="text-red-400 font-bold">
                              -
                              {formatCLP(
                                calculation.simResults.financials.fixedCosts,
                              )}
                            </span>
                          </div>
                          <div className="flex justify-between text-xs">
                            ...
                            <span className="text-red-400 font-bold">
                              -
                              {formatCLP(
                                calculation.simResults.financials.marketingCost,
                              )}
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="pt-6 border-t border-white/10 flex justify-between items-end">
                          ...
                          <div className="text-right">
                            ...
                            <p className="text-xl font-bold text-white">
                              {calculation.simResults.financials.margin.toFixed(
                                1,
                              )}
                              %
                            </p>
                    ...
                    <div className="col-span-2 bg-stone-900 p-8 rounded-3xl border border-white/5">
                      ...
                      <div className="grid grid-cols-2 gap-8">
                        <div>
                          ...
                          <p className="text-xs text-stone-500 mt-1">
                            Marketing: {formatCLP(simConfig.marketingBudget)}
                            /mes
                          </p>
                        </div>
                        <div className="text-right">
                          <p className="text-[10px] font-black uppercase tracking-widest text-stone-500 mb-2">
                            Utilidad Acumulada Año 1
                          </p>
                          <p className="text-2xl font-black text-emerald-400">
                            {formatCLP(
                              calculation.simResults.financials.projection.reduce(
                      ...
                      <div className="mt-8 p-4 bg-emerald-500/5 border border-emerald-500/10 rounded-2xl">
                        <p className="text-[10px] text-emerald-400 font-bold uppercase mb-2">
                          Escalamiento Controlado
                        </p>
                        <p className="text-xs text-stone-400">
                          Con un crecimiento del **10% mensual**, el negocio
                          escala de forma más estable. Al llegar al **Mes 12**,
                          estarás operando con aproximadamente **
                          {
                            calculation.simResults.financials.projection[11]
                              .houses
                          }{" "}
                          casas** y **
                          {
                          ...
                          equipos**. Este ritmo permite una mejor selección de
                    ...
                    <div className="col-span-2 bg-stone-900 p-8 rounded-3xl border border-white/5">
                      <h4 className="text-sm font-black uppercase tracking-widest text-stone-400 mb-8">
                        Estrategia de Marketing de Ecosistema
                      </h4>
                      <div className="grid grid-cols-2 gap-8">
                        <div className="bg-stone-800/50 p-6 rounded-2xl border border-white/5">
                          ...
                          <p className="text-xs text-stone-500 leading-relaxed">
                            Aprovechamos la recurrencia de las visitas de
                            mantención para ofrecer servicios del Marketplace.
                            El personal técnico actúa como "embajador"
                            detectando necesidades (ej: una filtración en el
                            jardín) y derivando al proveedor del Marketplace.
                          </p>
                        </div>
                        <div className="bg-stone-800/50 p-6 rounded-2xl border border-white/5">
                          <div className="flex items-center gap-3 mb-4">
                          ...
                          <p className="text-xs text-stone-500 leading-relaxed">
                            El presupuesto de marketing ahora promociona la
                            "Solución Total Hogar". Esto aumenta el valor
                            percibido de la marca y reduce el costo de
                            adquisición por servicio al compartir la inversión
                      ...
                      <div className="mt-8 p-4 bg-emerald-500/5 border border-emerald-500/10 rounded-2xl">
                        ...
                        <p className="text-xs text-stone-400">
                          Al derivar clientes a la plataforma de Marketplace, se
                          establece un modelo de **comisión por lead o venta
                          (10-15%)**. Esto genera una línea de ingresos
                          adicional con costo operativo cero para la estructura
                          principal de Tu Mayordomo.
                        </p>
                      </div>
                    </div>
                  </div>
